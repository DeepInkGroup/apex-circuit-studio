...
try {
 ...
 await page.locator('#trackName').fill('Handmade test circuit');await page.locator('#smoothness').fill('0.7');await expect(page.locator('#smoothnessValue')).toHaveText('Flowing');await page.locator('#biome').selectOption('forest');await page.locator('#facilitiesOption').uncheck();await page.locator('#save').click();
