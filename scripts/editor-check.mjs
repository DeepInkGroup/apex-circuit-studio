...
try {
 ...
 await page.locator('#trackName').fill('Handmade test circuit');await page.locator('#smoothness').fill('0.7');await expect(page.locator('#smoothnessValue')).toHaveText('Flowing');await page.locator('#curbWidth').fill('1.3');await page.locator('#runoffWidth').fill('2.2');await page.locator('#miterLimit').fill('1.5');await page.locator('#biome').selectOption('forest');await page.locator('#sceneryDensity').fill('150');await page.locator('#facilitiesOption').uncheck();await page.locator('#save').click();
